...
contract DummyERC721CollectionV2UpgradeInvalidStorage is OwnableInitializable, ERC721Initializable, NativeMetaTransaction {
    ...
    // It was placed before existing variables
    // This will cause variables to be messed up and return messy values
    // Always place new variables last for upgrades
